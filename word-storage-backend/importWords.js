...
const words = [
    ...
    { category: 'verbs_work', word: "переносити", translation: "carry", example: "He likes to carry a backpack when he goes hiking"},
    { category: 'verbs_work', word: "здійснювати", translation: "fulfill", example: "She worked hard to fulfill her dream"},
    { category: 'verbs_work', word: "робити", translation: "do", example: "She will do her homework after school"},
    { category: 'verbs_work', word: "зробити", translation: "make", example: "He will make a sandwich for lunch"},
    { category: 'verbs_work', word: "змішувати", translation: "mix", example: "She will mix the ingredients to make a cake"},
    { category: 'verbs_work', word: "псувати", translation: "spoil", example: "Leaving food out in the sun can spoil it"},
    { category: 'verbs_work', word: "кидати", translation: "throw", example: "She will throw the ball to her teammate"},
    { category: 'verbs_work', word: "падати", translation: "drop", example: "Be careful not to drop the glass"},
    { category: 'verbs_work', word: "керувати", translation: "manage", example: "She will manage the team to complete a project"},
    { category: 'verbs_work', word: "обробляти", translation: "handle", example: "He needs to handle the situation diplomatically"},
    { category: 'verbs_work', word: "полірувати", translation: "polish", example: "He likes to polish his shoes before events"},
    { category: 'verbs_work', word: "cпробувати", translation: "try", example: "She will try a new recipe for dinner"},
    { category: 'verbs_work', word: "запобігти", translation: "prevent", example: "The alarm system helps prevent unauthorized access"},
    { category: 'verbs_work', word: "вирішувати(задачу)", translation: "solve", example: "She will solve the math problem"},
    { category: 'verbs_work', word: "розв'язувати(проблему)", translation: "resolve", example: "He aims to resolve the conflict through communication"},
    { category: 'verbs_work', word: "спеціалізуватися", translation: "specialize", example: "He chose to specialize as a programmer"},
    { category: 'verbs_work', word: "підсвічувати", translation: "highlight", example: "She decided to highlight the room with lights"},
    { category: 'verbs_work', word: "отримати", translation: "retrieve", example: "He will retrieve the information from a database"},
    { category: 'verbs_work', word: "відтворити", translation: "recreate", example: "She will recreate the famous painting"},
    { category: 'verbs_work', word: "налагодити", translation: "rectify", example: "The IT department worked to rectify a issue"},
    { category: 'verbs_work', word: "виправити", translation: "fix", example: "I will fix this error today"},
    { category: 'verbs_work', word: "зав'язувати", translation: "tie", example: "He is learning how to tie his shoes"},
    { category: 'verbs_work', word: "анулювати/скасувати", translation: "undo", example: "She had to undo the last few edits"},
    { category: 'verbs_work', word: "застебнути", translation: "fasten", example: "Please fasten your helmet for safety"},
    { category: 'verbs_work', word: "будувати", translation: "build", example: "They plan to build a new house"},
    { category: 'verbs_work', word: "розстебнути", translation: "unfasten", example: "She decided to unfasten the buttons for comfort"},
    { category: 'verbs_work', word: "зварювати", translation: "weld", example: "He welded the metal pieces together"},
    { category: 'verbs_work', word: "приклеювати", translation: "stick", example: "He used glue to stick the pieces of paper together"},
    { category: 'verbs_work', word: "замінювати", translation: "substitute", example: "You can substitute butter with oil"},
    { category: 'verbs_work', word: "змочувати", translation: "moisten", example: "Moisten a stamp to activate the adhesive"},
    { category: 'verbs_work', word: "прибити цвях", translation: "nail", example: "To fix the picture he decided to nail it back"},
    { category: 'verbs_work', word: "проколоти", translation: "spike", example: "He used a nail to spike the wooden plank"},
    { category: 'verbs_work', word: "піднімати", translation: "pick up", example: "She helped pick up the toys after a party"},
    { category: 'verbs_work', word: "натирати", translation: "rub", example: "She needed to rub her hands to remove the sand"},
    { category: 'verbs_work', word: "пилити", translation: "saw", example: "He sawed the tree to create logs"},
    { category: 'verbs_work', word: "розкидати", translation: "scatter", example: "A wind scattered the leaves"},
    { category: 'verbs_work', word: "зішкрібати", translation: "scrape", example: "He accidentally scraped his car against the fence"},
    { category: 'verbs_work', word: "подряпати", translation: "scratch", example: "The cat likes to scratch its claws on a tree"},
    { category: 'verbs_work', word: "закручувати", translation: "screw", example: "He needed a screwdriver to screw the shelves"},
    { category: 'verbs_work', word: "упіймати", translation: "catch", example: "She tried to catch the ball but missed"},
    { category: 'verbs_work', word: "розсипати", translation: "spill", example: "Be careful not to spill the coffee"},
    { category: 'verbs_work', word: "змонтувати", translation: "assemble", example: "He followed instructions to assemble the bookshelf"},
    { category: 'verbs_work', word: "розбирати", translation: "disassemble", example: "They had to disassemble the furniture for moving"},
    { category: 'verbs_work', word: "проводити", translation: "conduct", example: "The scientist decided to conduct experiments"},
    { category: 'verbs_work', word: "знищувати", translation: "destroy", example: "He accidentally destroyed the document"},
    { category: 'verbs_work', word: "зносити", translation: "demolish", example: "The city decided to demolish an old bridge"},
    { category: 'verbs_work', word: "розбавляти", translation: "dilute", example: "Please dilute the juice with water"},
