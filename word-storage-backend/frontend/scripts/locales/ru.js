export default {
    ...
    rules: 'Выбери набор слов, например – ГЛАВНАЯ (зеленым отражено кол-во изученных слов, красным – еще оставшихся для изучения). \n' +
        'Правила максимально просты: \n' +
        '- рядом с украинским словом вписывай английский перевод и жми ENTER или клавишу для проверки "Check answer"; \n' +
        '- если ты ввел неправильный ответ – система подскажет тебе правильное слово и предложит составить предложение с использованием этого слова в контексте для лучшего запоминания; \n' +
        'Если устал или хочешь выбрать другую группу слов – жми END GAME -> твой прогресс будет сохранен и ты сможешь вернуться к нему позже.',
